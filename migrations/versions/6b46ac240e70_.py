...
Revision ID: 6b46ac240e70
Revises: 1aeb30b6dfe0
Create Date: 2020-03-07 13:50:02.250465
...
revision = '6b46ac240e70'
down_revision = '1aeb30b6dfe0'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('users', sa.Column('email_ver', sa.Integer(), nullable=True))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('users', 'email_ver')
