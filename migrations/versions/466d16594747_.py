...
Revision ID: 466d16594747
Revises: 8ab44eb0c5a6
Create Date: 2019-12-09 21:03:08.167093
...
revision = '466d16594747'
down_revision = '8ab44eb0c5a6'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('request__des', sa.Column('description', sa.String(length=150), nullable=True))
...
def downgrade():
    ...
    op.add_column('request__des', sa.Column('req_description', mysql.VARCHAR(length=150), nullable=True))
